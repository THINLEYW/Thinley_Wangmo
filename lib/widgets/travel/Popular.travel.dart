        ...
        children: [
          ...
          Container(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: places.map((PlacesCardModel e){
                  return PopularCardTravel(title: e.title);
                }).toList()
             ),
            ),
          )
